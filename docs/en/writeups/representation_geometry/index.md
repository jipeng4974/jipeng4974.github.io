...
> In the iterative loop of representation learning, one should try to estimate the intrinsic dimension of the embedded submanifold and design a reasonable ambient space at both the input and output ends.
