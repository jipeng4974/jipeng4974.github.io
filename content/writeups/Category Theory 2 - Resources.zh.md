...
![接线图 1](https://wujipeng.com/img/wiring_diagrams_1.png)

有了对称幺半结构，关系也可以并联排列。
![接线图 2](https://wujipeng.com/img/wiring_diagrams_2.png)
上面整张接线图表达的是"若 $t\le v, w+u\le x+z, v+x\le y$，则 $t+u\le y+z$"。

我们可以并排画两条线来表示两个标签的幺半积。
![接线图 3](https://wujipeng.com/img/wiring_diagrams_3.png)
